...
<html>
    ...
    <body>
        ...
        <div id="allForms">
            ...
            <h2>Найдите нужного режиссера и добавьте его</h2>

            <form name="actorsForm">
                <input type="hidden" id = "searchType" name="searchType" value="movie"/>
                <input type="text" id="searchInput" placeholder="Search director...">
            </form>
            ...
            <div id = "some">
                ...
                <div id = "forms">
                    ...
                    <form class="searchBtn" id = "searchForm" method="post" action="<c:url value="/bind-directors"/>">
                        <input type="hidden" id = "idList" name="movie_directors" value="">
                        <input type="hidden" id = "namesList" name="directorsNames" value="">
